...
\customcventry{10/2025 ‐ 12/2025}{}{学术论文翻译垂直领域大模型微调}{}{}{}{
  \begin{itemize}[leftmargin=0.61cm, label={\textbullet}]
    ...
    \item \textbf{实验结果：} Base模型(0.2843) $\rightarrow$ SFT LoRA(Rank 8, Alpha 32, \textbf{0.5092}) $\rightarrow$ 全参数微调(\textbf{0.5614}) $\rightarrow$ DPO训练(\textbf{0.5710})；GRPO训练表现稳定，在Step 100/200分别达到\textbf{0.5636/0.5670}。
  \end{itemize}
}}
